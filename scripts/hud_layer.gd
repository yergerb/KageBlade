...
func _draw() -> void:
	...
	draw_string(_font(), Vector2(center_x - 56, 82), "GODOT SLICE 01", HORIZONTAL_ALIGNMENT_CENTER, 112, 13, Color(0.8, 0.76, 0.68, 0.9))
...
func _draw_bar(fighter: Variant, pos: Vector2, width: float, left_name: bool) -> void:
	...
	draw_string(_font(), name_pos, fighter.name, HORIZONTAL_ALIGNMENT_LEFT, 128, 22, Color.WHITE)
